...
\begin{DoxyCode}{0}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00001}00001 \textcolor{preprocessor}{\#include "{}ASManager.h"{}}}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00002}00002 }
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00003}00003 ASManager::ASManager() \{\}}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00004}00004 }
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00005}00005 \textcolor{keywordtype}{void} ASManager::createASForScene(VulkanDevice* device,}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00006}00006                                  VkCommandPool commandPool, Scene* scene) \{}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00007}00007   this-\/>vulkanDevice = device;}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00008}00008   createBLAS(device, commandPool, scene);}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00009}00009   createTLAS(device, commandPool, scene);}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00012}00012 \textcolor{keywordtype}{void} ASManager::createBLAS(VulkanDevice* device, VkCommandPool commandPool,}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00013}00013                            Scene* scene) \{}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00022}00022           device-\/>getLogicalDevice(), \textcolor{stringliteral}{"{}vkGetBufferDeviceAddress"{}});}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00023}00023 }
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00024}00024   std::vector<BlasInput> blas\_input(scene-\/>getModelCount());}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00027}00027        model\_index < static\_cast<uint32\_t>(scene-\/>getModelCount());}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00028}00028        model\_index++) \{}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00029}00029     std::shared\_ptr<Model> mesh\_model = scene-\/>get\_model\_list()[model\_index];}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00041}00041       objectToVkGeometryKHR(device, mesh\_model-\/>getMesh(mesh\_index),}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00056}00056   build\_as\_structures.resize(scene-\/>getModelCount());}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00061}00061   \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} i = 0; i < scene-\/>getModelCount(); i++) \{}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00065}00065     createAccelerationStructureInfosBLAS(device, build\_as\_structures[i],}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00073}00073   VulkanBuffer scratchBuffer;}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00074}00074 }
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00075}00075   scratchBuffer.create(device, max\_scratch\_size,}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00085}00085   scratch\_buffer\_device\_address\_info.buffer = scratchBuffer.getBuffer();}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00088}00088       device-\/>getLogicalDevice(), \&scratch\_buffer\_device\_address\_info);}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00093}00093   VkCommandBuffer command\_buffer = commandBufferManager.beginCommandBuffer(}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00094}00094       device-\/>getLogicalDevice(), commandPool);}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00095}00095 }
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00096}00096   \textcolor{keywordflow}{for} (\textcolor{keywordtype}{size\_t} i = 0; i < scene-\/>getModelCount(); i++) \{}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00097}00097     createSingleBlas(device, command\_buffer, build\_as\_structures[i],}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00112}00112   commandBufferManager.endAndSubmitCommandBuffer(}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00113}00113       device-\/>getLogicalDevice(), commandPool, device-\/>getGraphicsQueue(),}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00117}00117     blas.emplace\_back(b.single\_blas);}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00120}00120   scratchBuffer.cleanUp();}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00123}00123 \textcolor{keywordtype}{void} ASManager::createTLAS(VulkanDevice* device, VkCommandPool commandPool,}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00124}00124                            Scene* scene) \{}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00133}00133               device-\/>getLogicalDevice(),}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00138}00138           device-\/>getLogicalDevice(), \textcolor{stringliteral}{"{}vkCreateAccelerationStructureKHR"{}});}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00142}00142           device-\/>getLogicalDevice(), \textcolor{stringliteral}{"{}vkGetBufferDeviceAddress"{}});}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00146}00146           device-\/>getLogicalDevice(), \textcolor{stringliteral}{"{}vkCmdBuildAccelerationStructuresKHR"{}});}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00151}00151               device-\/>getLogicalDevice(),}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00155}00155   tlas\_instances.reserve(scene-\/>getModelCount());}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00156}00156 }
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00157}00157   \textcolor{keywordflow}{for} (\textcolor{keywordtype}{size\_t} model\_index = 0; model\_index < scene-\/>getModelCount();}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00161}00161     glm::mat4 transpose\_transform =}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00162}00162         glm::transpose(scene-\/>getModelMatrix(\textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{int}\textcolor{keyword}{>}(model\_index)));}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00171}00171         blas[model\_index].vulkanAS;}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00175}00175             device-\/>getLogicalDevice(),}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00194}00194   VkCommandBuffer command\_buffer = commandBufferManager.beginCommandBuffer(}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00195}00195       device-\/>getLogicalDevice(), commandPool);}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00196}00196 }
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00197}00197   VulkanBuffer geometryInstanceBuffer;}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00198}00198 }
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00199}00199   vulkanBufferManager.createBufferAndUploadVectorOnDevice(}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00212}00212       geometryInstanceBuffer.getBuffer();}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00216}00216           device-\/>getLogicalDevice(),}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00276}00276       device-\/>getLogicalDevice(), VK\_ACCELERATION\_STRUCTURE\_BUILD\_TYPE\_HOST\_KHR,}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00281}00281   VulkanBuffer\& tlasVulkanBuffer = tlas.vulkanBuffer;}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00282}00282   tlasVulkanBuffer.create(}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00295}00295   acceleration\_structure\_create\_info.buffer = tlasVulkanBuffer.getBuffer();}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00303}00303   VkAccelerationStructureKHR\& tlAS = tlas.vulkanAS;}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00304}00304   pvkCreateAccelerationStructureKHR(device-\/>getLogicalDevice(),}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00308}00308   VulkanBuffer scratchBuffer;}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00309}00309 }
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00310}00310   scratchBuffer.create(device,}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00321}00321   scratch\_buffer\_device\_address\_info.buffer = scratchBuffer.getBuffer();}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00324}00324       device-\/>getLogicalDevice(), \&scratch\_buffer\_device\_address\_info);}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00336}00336       scene-\/>getModelCount();}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00349}00349   commandBufferManager.endAndSubmitCommandBuffer(}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00350}00350       device-\/>getLogicalDevice(), commandPool, device-\/>getGraphicsQueue(),}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00351}00351       command\_buffer);}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00352}00352   scratchBuffer.cleanUp();}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00353}00353   geometryInstanceBuffer.cleanUp();}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00356}00356 \textcolor{keywordtype}{void} ASManager::cleanUp() \{}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00359}00359           vulkanDevice-\/>getLogicalDevice(),}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00362}00362   pvkDestroyAccelerationStructureKHR(vulkanDevice-\/>getLogicalDevice(),}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00363}00363                                      tlas.vulkanAS, \textcolor{keyword}{nullptr});}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00364}00364 }
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00365}00365   tlas.vulkanBuffer.cleanUp();}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00366}00366 }
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00367}00367   \textcolor{keywordflow}{for} (\textcolor{keywordtype}{size\_t} index = 0; index < blas.size(); index++) \{}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00368}00368     pvkDestroyAccelerationStructureKHR(vulkanDevice-\/>getLogicalDevice(),}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00369}00369                                        blas[index].vulkanAS, \textcolor{keyword}{nullptr});}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00370}00370 }
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00371}00371     blas[index].vulkanBuffer.cleanUp();}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00375}00375 ASManager::\string~ASManager() \{\}}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00376}00376 }
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00377}00377 \textcolor{keywordtype}{void} ASManager::createSingleBlas(}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00378}00378     VulkanDevice* device, VkCommandBuffer command\_buffer,}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00379}00379     BuildAccelerationStructure\& build\_as\_structure,}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00383}00383           device-\/>getLogicalDevice(), \textcolor{stringliteral}{"{}vkCreateAccelerationStructureKHR"{}});}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00387}00387           device-\/>getLogicalDevice(), \textcolor{stringliteral}{"{}vkCmdBuildAccelerationStructuresKHR"{}});}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00395}00395       build\_as\_structure.size\_info.accelerationStructureSize;}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00396}00396   VulkanBuffer\& blasVulkanBuffer = build\_as\_structure.single\_blas.vulkanBuffer;}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00397}00397   blasVulkanBuffer.create(}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00398}00398       device, build\_as\_structure.size\_info.accelerationStructureSize,}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00405}00405   acceleration\_structure\_create\_info.buffer = blasVulkanBuffer.getBuffer();}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00406}00406   VkAccelerationStructureKHR\& blas\_as = build\_as\_structure.single\_blas.vulkanAS;}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00407}00407   pvkCreateAccelerationStructureKHR(device-\/>getLogicalDevice(),}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00411}00411   build\_as\_structure.build\_info.dstAccelerationStructure = blas\_as;}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00412}00412   build\_as\_structure.build\_info.scratchData.deviceAddress =}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00416}00416                                        \&build\_as\_structure.build\_info,}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00417}00417                                        \&build\_as\_structure.range\_info);}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00420}00420 \textcolor{keywordtype}{void} ASManager::createAccelerationStructureInfosBLAS(}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00421}00421     VulkanDevice* device, BuildAccelerationStructure\& build\_as\_structure,}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00422}00422     BlasInput\& blas\_input, VkDeviceSize\& current\_scretch\_size,}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00427}00427               device-\/>getLogicalDevice(),}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00430}00430   build\_as\_structure.build\_info.sType =}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00432}00432   build\_as\_structure.build\_info.type =}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00433}00433       VK\_ACCELERATION\_STRUCTURE\_TYPE\_BOTTOM\_LEVEL\_KHR;}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00434}00434   build\_as\_structure.build\_info.flags =}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00436}00436   build\_as\_structure.build\_info.mode =}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00437}00437       VK\_BUILD\_ACCELERATION\_STRUCTURE\_MODE\_BUILD\_KHR;}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00438}00438   build\_as\_structure.build\_info.geometryCount =}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00439}00439       \textcolor{keyword}{static\_cast<}uint32\_t\textcolor{keyword}{>}(blas\_input.as\_geometry.size());}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00440}00440   build\_as\_structure.build\_info.pGeometries = blas\_input.as\_geometry.data();}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00441}00441 }
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00442}00442   build\_as\_structure.range\_info = blas\_input.as\_build\_offset\_info.data();}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00443}00443 }
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00444}00444   build\_as\_structure.size\_info.sType =}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00448}00448       blas\_input.as\_build\_offset\_info.size());}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00451}00451        temp < static\_cast<uint32\_t>(blas\_input.as\_build\_offset\_info.size());}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00454}00454         blas\_input.as\_build\_offset\_info[temp].primitiveCount;}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00457}00457       device-\/>getLogicalDevice(),}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00458}00458       VK\_ACCELERATION\_STRUCTURE\_BUILD\_TYPE\_DEVICE\_KHR,}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00459}00459       \&build\_as\_structure.build\_info, max\_primitive\_cnt.data(),}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00460}00460       \&build\_as\_structure.size\_info);}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00461}00461 }
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00462}00462   current\_size = build\_as\_structure.size\_info.accelerationStructureSize;}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00463}00463   current\_scretch\_size = build\_as\_structure.size\_info.buildScratchSize;}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00466}00466 \textcolor{keywordtype}{void} ASManager::objectToVkGeometryKHR(}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00467}00467     VulkanDevice* device, Mesh* mesh,}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00478}00478           device-\/>getLogicalDevice(), \textcolor{stringliteral}{"{}vkGetBufferDeviceAddress"{}});}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00485}00485   vertex\_buffer\_device\_address\_info.buffer = mesh-\/>getVertexBuffer();}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00491}00491   index\_buffer\_device\_address\_info.buffer = mesh-\/>getIndexBuffer();}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00496}00496       device-\/>getLogicalDevice(), \&vertex\_buffer\_device\_address\_info);}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00498}00498       device-\/>getLogicalDevice(), \&index\_buffer\_device\_address\_info);}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00516}00516   acceleration\_structure\_triangles\_data.vertexStride = \textcolor{keyword}{sizeof}(Vertex);}
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00517}00517   acceleration\_structure\_triangles\_data.maxVertex = mesh-\/>getVertexCount();}
...
\DoxyCodeLine{\Hypertarget{_a_s_manager_8cpp_source_l00541}00541       mesh-\/>getIndexCount() / 3;}
