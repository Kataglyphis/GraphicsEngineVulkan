...
void VulkanBufferManager::copyBuffer(VkDevice device, VkQueue transfer_queue,
  ...
  VkCommandBuffer command_buffer =
      commandBufferManager.beginCommandBuffer(device, transfer_command_pool);
  ...
  vkCmdCopyBuffer(command_buffer, src_buffer.getBuffer(),
                  dst_buffer.getBuffer(), 1, &buffer_copy_region);
...
void VulkanBufferManager::copyImageBuffer(VkDevice device,
                                          ...
                                          VkCommandPool transfer_command_pool,
                                          VkBuffer src_buffer, VkImage image,
  ...
  vkCmdCopyBufferToImage(transfer_command_buffer, src_buffer, image,
