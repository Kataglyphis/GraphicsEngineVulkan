...
void Rasterizer::init(	VulkanDevice* device, VulkanSwapChain* vulkanSwapChain,
...
void Rasterizer::recordCommands(VkCommandBuffer& commandBuffer, uint32_t image_index, Scene* scene,
...
void Rasterizer::createFramebuffer()
{
	...
	for (size_t i = 0; i < framebuffer.size(); i++) {
		...
		std::array<VkImageView, 2> attachments = {
							offscreenTextures[i].getImageView(),
