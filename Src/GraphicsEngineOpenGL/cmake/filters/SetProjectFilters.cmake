...
set(GUI_FILTER ${GUI_FILTER} ${PROJECT_GUI_SRC_DIR}GUI.cpp ${PROJECT_GUI_SRC_DIR}GUI.hpp)
# ---- GUI FILTER  --- END
...
set(CAMERA_FILTER ${CAMERA_FILTER} ${PROJECT_CAMERA_SRC_DIR}Camera.cpp ${PROJECT_CAMERA_SRC_DIR}Camera.hpp)
# ---- CAMERA FILTER  --- END
...
set(LOAD_SCREEN_FILTER ${LOAD_SCREEN_FILTER} ${PROJECT_LOAD_SCREEN_SRC_DIR}LoadingScreen.cpp
...
set(LIGHT_FILTER ${LIGHT_FILTER} ${PROJECT_LIGHT_SRC_DIR}Light.cpp ${PROJECT_LIGHT_SRC_DIR}Light.hpp)
# ---- LIGHT FILTER  --- END
...
set(SHADOWS_FILTER ${SHADOWS_FILTER} ${PROJECT_SHADOWS_SRC_DIR}ShadowMap.cpp ${PROJECT_SHADOWS_SRC_DIR}ShadowMap.hpp)
# ---- SHADOWS FILTER  --- END

# ---- SKY_BOX FILTER  --- BEGIN
set(PROJECT_SKY_BOX_SRC_DIR ${PROJECT_SRC_DIR}scene/sky_box/)
set(SKY_BOX_FILTER ${SKY_BOX_FILTER} ${PROJECT_SKY_BOX_SRC_DIR}SkyBox.cpp ${PROJECT_SKY_BOX_SRC_DIR}SkyBox.hpp)
# ---- SKY_BOX FILTER  --- END
...
set(WINDOW_FILTER ${WINDOW_FILTER} ${PROJECT_WINDOW_SRC_DIR}Window.cpp ${PROJECT_WINDOW_SRC_DIR}Window.hpp)
# ---- WINDOW FILTER  --- END
